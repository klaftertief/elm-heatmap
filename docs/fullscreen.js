...
var _user$project$Fullscreen$clientPosition = A4(
	_elm_lang$core$Json_Decode$map3,
	_klaftertief$elm_heatmap$Heatmap$Point,
...
var _user$project$Fullscreen$targetValueFloat = function (fallback) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (value) {
...
var _user$project$Fullscreen$heatmapConfig = function (_p1) {
	var _p2 = _p1;
	return A2(
		_klaftertief$elm_heatmap$Heatmap$withBlur,
		_p2.blur,
		A2(
			...
			_klaftertief$elm_heatmap$Heatmap$config(
				{
					toPoint: _elm_lang$core$Basics$identity,
					gradient: _elm_lang$core$Tuple$second(_p2.gradient)
				})));
};
var _user$project$Fullscreen$gradients = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'Black Aqua White', _1: _klaftertief$elm_heatmap$Heatmap_Gradient$blackAquaWhite},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'Blue Red', _1: _klaftertief$elm_heatmap$Heatmap_Gradient$blueRed},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'Color Spectrum', _1: _klaftertief$elm_heatmap$Heatmap_Gradient$colorSpectrum},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'Deep Sea', _1: _klaftertief$elm_heatmap$Heatmap_Gradient$deepSea},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'Incandescent', _1: _klaftertief$elm_heatmap$Heatmap_Gradient$incandescent},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'Heated Metal', _1: _klaftertief$elm_heatmap$Heatmap_Gradient$heatedMetal},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'Stepped Colors', _1: _klaftertief$elm_heatmap$Heatmap_Gradient$steppedColors},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'Sunrise', _1: _klaftertief$elm_heatmap$Heatmap_Gradient$sunrise},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'Visible Spectrum', _1: _klaftertief$elm_heatmap$Heatmap_Gradient$visibleSpectrum},
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Fullscreen$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'AddPoint':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						points: {ctor: '::', _0: _p3._0, _1: model.points}
					});
			case 'ClearPoints':
				return _elm_lang$core$Native_Utils.update(
					model,
			...
			default:
				...
				var _p4 = A2(
					...
					A2(
						_elm_lang$core$Maybe$map,
						function (g) {
							return {ctor: '_Tuple2', _0: _p5, _1: g};
						},
						A2(_elm_lang$core$Dict$get, _p5, _user$project$Fullscreen$gradients)));
				var gradientName = _p4._0;
				var gradient = _p4._1;
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						gradient: {ctor: '_Tuple2', _0: gradientName, _1: gradient}
					});
		}
	});
var _user$project$Fullscreen$model = {
	points: {ctor: '[]'},
	radius: 25,
	blur: 15,
	gradient: {ctor: '_Tuple2', _0: 'Visible Spectrum', _1: _klaftertief$elm_heatmap$Heatmap_Gradient$visibleSpectrum}
};
var _user$project$Fullscreen$Model = F4(
	function (a, b, c, d) {
		return {points: a, radius: b, blur: c, gradient: d};
	});
var _user$project$Fullscreen$SetGradient = function (a) {
	return {ctor: 'SetGradient', _0: a};
};
var _user$project$Fullscreen$SetBlur = function (a) {
	return {ctor: 'SetBlur', _0: a};
};
var _user$project$Fullscreen$SetRadius = function (a) {
	return {ctor: 'SetRadius', _0: a};
};
var _user$project$Fullscreen$ClearPoints = {ctor: 'ClearPoints'};
var _user$project$Fullscreen$AddPoint = function (a) {
	return {ctor: 'AddPoint', _0: a};
};
var _user$project$Fullscreen$view = function (model) {
	return A2(
			...
			_0: A2(
				_elm_lang$svg$Svg$svg,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$style('position: fixed; top: 0; bottom: 0;'),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$svg$Svg_Events$on,
									'mousemove',
									A2(_elm_lang$core$Json_Decode$map, _user$project$Fullscreen$AddPoint, _user$project$Fullscreen$clientPosition)),
								_1: {
									ctor: '::',
									_0: A3(
										_elm_lang$html$Html_Events$onWithOptions,
										...
										A2(
											_elm_lang$core$Json_Decode$map,
											_user$project$Fullscreen$AddPoint,
											A2(
												_elm_lang$core$Json_Decode$at,
												{
													ctor: '::',
												...
												_user$project$Fullscreen$clientPosition))),
									_1: {ctor: '[]'}
								}
							}
						}
				...
				},
				{
					...
					_0: A2(
						...
						_user$project$Fullscreen$heatmapConfig(model),
						model.points),
					_1: {ctor: '[]'}
				}),
			_1: {
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'padding', _1: '2px 16px'},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'margin', _1: '0 auto'},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'top', _1: '32px'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'max-width', _1: '800px'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'background', _1: 'rgba(0,0,0,0.1)'},
													_1: {
														ctor: '::',
														...
														_1: {
															...
															_1: {
																...
																_0: _elm_lang$html$Html_Attributes$value(
																	_elm_lang$core$Basics$toString(model.radius)),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html_Events$on,
																		...
																		A2(
																			_elm_lang$core$Json_Decode$map,
																			_user$project$Fullscreen$SetRadius,
																			_user$project$Fullscreen$targetValueFloat(model.radius))),
																	_1: {ctor: '[]'}
																}
															}
														}
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Blur'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$value(
																		_elm_lang$core$Basics$toString(model.blur)),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			_elm_lang$html$Html_Events$on,
																			...
																			A2(
																				_elm_lang$core$Json_Decode$map,
																				_user$project$Fullscreen$SetBlur,
																				_user$project$Fullscreen$targetValueFloat(model.blur))),
																		_1: {ctor: '[]'}
																	}
																}
															}
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Gradient'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$select,
														{
															...
															_0: A2(
																_elm_lang$html$Html_Events$on,
																'change',
																A2(_elm_lang$core$Json_Decode$map, _user$project$Fullscreen$SetGradient, _elm_lang$html$Html_Events$targetValue)),
															_1: {ctor: '[]'}
														},
														A2(
															_elm_lang$core$List$map,
																	...
																	_elm_lang$html$Html$option,
																	{
																		...
																		_0: _elm_lang$html$Html_Attributes$selected(
																			_elm_lang$core$Native_Utils.eq(
																				name,
																				_elm_lang$core$Tuple$first(model.gradient))),
																		_1: {ctor: '[]'}
																	},
																	{
																		ctor: '::',
															...
															_elm_lang$core$Dict$keys(_user$project$Fullscreen$gradients))),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$Fullscreen$ClearPoints),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Move your mouse to add points. But be careful, many points will slow down the rendering.'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
...
var _user$project$Fullscreen$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Fullscreen$model, update: _user$project$Fullscreen$update, view: _user$project$Fullscreen$view})();

var Elm = {};
Elm['Fullscreen'] = Elm['Fullscreen'] || {};
if (typeof _user$project$Fullscreen$main !== 'undefined') {
    _user$project$Fullscreen$main(Elm['Fullscreen'], 'Fullscreen', undefined);
}
